...
faker = Faker()
fake = Faker()
token = '2006223155:AAHVfvfv1UI3hu_lDz_MTCJnsWpPlP7Zs_0'
bot = telebot.TeleBot(token, parse_mode="HTML")
admin = ['1420171187', '591531661', '5023850793'] #ادمنز
users = {}
vip_keys = {}
vip_users = {}
vip_expirations = {}
...
def start(message):
    ...
    try:
        ...
        nm = ""   
    if user_id in admin:
        req = requests.get(f'https://api.telegram.org/bot2006223155:AAHVfvfv1UI3hu_lDz_MTCJnsWpPlP7Zs_0/getChatMember?chat_id={channel_id}&user_id={user_id}').json()
